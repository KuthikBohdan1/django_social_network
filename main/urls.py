...
urlpatterns = [
    ...
    path('comment-post<int:post_id>', views.CommentPostCreateView.as_view(), name = "comment-post"),
    path('api/posts/', views.PostListAPiView.as_view(), name="posts_api_list"),
    path('', views.posts_list_view, name='home'),
    ...
    path('group-user-create/<int:group_id>/', views.GroupUserCreteView.as_view(), name="group_user_create"),
    path('user-join/<int:group_id>/', views.ajaxJoinGroup, name="join-group"),
